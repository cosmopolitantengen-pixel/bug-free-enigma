...
Expand browser-level E2E coverage from the current smoke paths into approval decisions, schedule controls, and incident response flows while keeping the existing operational data contract stable.
