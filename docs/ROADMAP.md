...
- Chat can now create Strategic Goal confirmation cards from explicit goal-setting language; confirmed goals use the existing Goal service, Audit, persistence, and restart recovery path, while ordinary conversation includes active goal context.
