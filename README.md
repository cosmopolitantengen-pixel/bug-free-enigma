...
- The V1 Workflow catalog defines all 10 required processes; document generation, task planning, quality checking, and retrospectives have native controlled runners.
