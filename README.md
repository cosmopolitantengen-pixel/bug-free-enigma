...
- The V1 Workflow catalog defines all 10 required processes; document generation, task planning, Agent collaboration, Skill/Agent Missing handling, quality checking, and retrospectives have native controlled runners.
